  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            if (widget.groupClass.turno != null || widget.groupClass.dia != null)
              Text(
      ...
      body: _loading
          ...
          : Column(
              children: [
                if (_loadingSession) const LinearProgressIndicator(minHeight: 2),
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Spacer(),
                      Text('$total Total', style: Theme.of(context).textTheme.labelLarge),
                    ],
                  ),
                ),
                Padding(
                ...
                Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, i) => _StudentRow(
                      student: filtered[i],
                      onChange: (st) => setState(() {
                        final idx = _students.indexWhere((s) => s.id == filtered[i].id);
      ...
      bottomNavigationBar: SafeArea(
        ...
        child: SizedBox(
          ...
          child: FilledButton.icon(
            ...
            label: Text(
              _hasExisting ? 'Actualizar Lista de Asistencia' : 'Guardar Lista de Asistencia',
            ),
          ),
        ),
      ),
    ...
    try {
      ...
      await AttendanceService.instance.saveAttendance(
        ...
        sessionMeta: {
          ...
          'schedule': '${fmtTime(widget.groupClass.start)}-${fmtTime(widget.groupClass.end)}',
      ...
      final msg = e.toString().contains('permission-denied')
          ? 'No tienes permisos para escribir. Verifica autenticación y Reglas.'
          : 'No se pudo guardar/sincronizar: $e';
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: Row(
          ...
          children: [
            statusIcon(AttendanceStatus.present, Icons.check_circle, Colors.green),
            statusIcon(AttendanceStatus.late, Icons.access_time_filled, Colors.orange),
